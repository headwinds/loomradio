...
export class FilePlayer extends Component {
  ...
  load(url) {
    console.log("FilePlayer -> load -> load");

    const { hlsVersion, dashVersion } = this.props.config.file;
    if (this.shouldUseHLS(url)) {
      console.log("FilePlayer -> load -> shouldUseHLS");
    ...
    if (this.shouldUseDASH(url)) {
      console.log("FilePlayer -> load -> shouldUseDASH");
    ...
    if (url instanceof Array) {
      ...
      console.log("FilePlayer -> load -> isMediaStream");
      try {
